...
void ui_Screen1_screen_init(void)
{
    ...
    lv_obj_set_style_text_color(menu, lv_color_hex(0xFFFFFF), LV_PART_MAIN);
    ...
    lv_obj_set_style_bg_color(section, lv_color_hex(0x0a0a0a), LV_PART_MAIN);
    lv_obj_set_style_text_color(section, lv_color_hex(0xFFFFFF), LV_PART_MAIN);
    ...
    lv_obj_set_style_text_color(root_page, lv_color_hex(0xFFFFFF), LV_PART_MAIN);
    section = lv_menu_section_create(root_page);
    lv_obj_set_style_bg_color(section, lv_color_hex(0x0a0a0a), LV_PART_MAIN);
    lv_obj_set_style_text_color(section, lv_color_hex(0xFFFFFF), LV_PART_MAIN);

    cont = create_text(section, LV_SYMBOL_SETTINGS, "Mechan", LV_MENU_ITEM_BUILDER_VARIANT_1);
    ...
    cont = create_text(section, LV_SYMBOL_SETTINGS, "MenuM", LV_MENU_ITEM_BUILDER_VARIANT_1);
    lv_menu_set_load_page_event(menu, cont, sub_menu_mode_page);

    lv_menu_set_sidebar_page(menu, root_page);

    lv_event_send(lv_obj_get_child(lv_obj_get_child(lv_menu_get_cur_sidebar_page(menu), 0), 0), LV_EVENT_CLICKED, NULL); // Inside ID - 0: Settings, 2: Others. Outside ID - 0: Mechan, 2: Display
}
