...
#define RE1_A_GPIO   14
#define RE1_B_GPIO   12
#define RE1_BTN_GPIO 13

#elif HELPER_TARGET_IS_ESP32
#define RE1_A_GPIO   9
#define RE1_B_GPIO   10
#define RE1_BTN_GPIO 11
#define RE2_A_GPIO   12
#define RE2_B_GPIO   13
#define RE2_BTN_GPIO 14
...
void test(void *arg)
{
    ...
    // Add one encoder
    memset(&re2, 0, sizeof(rotary_encoder_t));
    re2.pin_a = RE2_A_GPIO;
    re2.pin_b = RE2_B_GPIO;
    re2.pin_btn = RE2_BTN_GPIO;
    ESP_ERROR_CHECK(rotary_encoder_add(&re2));

    rotary_encoder_event_t e;
    int32_t val1 = 0;

    ESP_LOGI(TAG, "Initial value: %" PRIi32, val1);
    while (1)
    {
        ...
        switch (e.type)
        {
            case RE_ET_BTN_PRESSED:
                ...
                ESP_LOGI(TAG, "Button pressed from %d", re2.index);
                break;
